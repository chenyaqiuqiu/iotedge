...
echo "project path: $BUILD_REPOSITORY_LOCALPATH/edge-agent/test/Microsoft.Azure.Devices.Edge.Agent.Core.Test/bin/Release/netcoreapp2.1/Microsoft.Azure.Devices.Edge.Agent.Core.Test.dll"
